...
sudo apt update && sudo apt install -y nmap && sudo apt install -y recon-ng && sudo apt install -y dnsenum && sudo apt install -y hydra && sudo apt install -y dirb && sudo apt install -y sqlmap && sudo apt install -y dnsmap && sudo apt install -y wfuzz && sudo apt install -y wpscan && sudo apt install -y joomscan && sudo apt install -y commix && sudo apt install -y theharvester && sudo apt install -y gobuster && sudo apt install -y subfinder && sudo apt install -y whatweb && sudo apt install -y fierce && sudo apt install -y aircrack-ng && sudo apt install -y john && sudo apt install -y nikto && sudo apt install -y openssh-client && sudo apt install -y smbclient
